...
class MosaicPretrainedModule(PreTrainedModel):
    ...
    def _set_gradient_checkpointing(self, module, value=False):
        if isinstance(module, (MosaicGPT,)):
            module.gradient_checkpointing = value


class MosaicGPT(MosaicPretrainedModule):
    ...
    def forward(
        ...
        for b_idx, block in enumerate(self.transformer.blocks):  # type: ignore
            ...
            if self.training and self.gradient_checkpointing:
                def f1(module):
                    def f2(*input):
                        return module(*input, past_key_value=past_key_value,
                                      attn_bias=attn_bias,
                                      attention_mask=attention_mask,
