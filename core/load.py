...
def load(path: typing.Union[str, os.PathLike], path_data: typing.Union[str, os.PathLike], vocab_size: int = 65,
         ...
         chunk_size: int = 328, number_of_embedded: int = 324, device: str = 'cuda' if torch.cuda.is_available() else 'cpu',
         head_size: int = 64, number_of_layers: int = 12, number_of_head: int = 12):
    ...
    m = BLM(vocab_size=vocab_size, chunk_size=chunk_size, number_of_embedded=number_of_embedded, head_size=head_size, number_of_layers=number_of_layers,
